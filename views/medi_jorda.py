...
class Dialogo_jorda(QDialog):
    ...
    def setup_ui(self):
        ...
        self.btn_aceptar = QPushButton("Registrar jornada")
    ...
    def agregar_fila_medicamento(self, medicamento):
        ...
        for fila in range(self.tabla_medicamentos.rowCount()):
            ...
            if nombre_existente == medicamento[1]:
        ...
        # Nombre medicamento
        lbl_nombre = QLabel(medicamento[1])
